...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center border-2 border-foreground bg-muted p-1 text-muted-foreground',
      className
    )}
    {...props}
  />
